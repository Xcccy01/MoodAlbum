...
| 移动端 Mobile | Capacitor 8 (Android) |
| 样式 Styling | 手写 CSS, 毛玻璃风格 Glassmorphism |
| 测试 Testing | Playwright E2E + Autocannon 压测 |
...
### 第 1 步：准备服务器 / Step 1: Prepare Server
...
### 第 2 步：安装环境 / Step 2: Install Dependencies
...
### 第 4 步：配置环境变量 / Step 4: Configure Environment
...
> Too lazy to think of a random string? Run the command above.

### 第 5 步：安装依赖并启动 / Step 5: Install & Start
...
### 第 6 步：配置 Systemd 守护进程 / Step 6: Setup Systemd Service
...
### 第 7 步：配置 Nginx 反向代理 / Step 7: Configure Nginx
...
### 第 8 步：开防火墙 / Step 8: Open Firewall
...
### 打包 Android APK / Build Android APK (Optional)
...
> MIT — Use it however you like, as long as it makes you happy.

---

<p align="center">
  <i>如果这个小项目暖到了你，点个 Star 让我也开心一下吧 🌟</i><br/>
